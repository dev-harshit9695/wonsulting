...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 animate-fade-in">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 transform transition-transform duration-300 hover:scale-105">
          <div className="text-center">
            <img
              className="mx-auto h-12 w-auto"
              src={wonsultingLogo}
          ...
          <form className="space-y-6 mt-8" onSubmit={handleSubmit}>
            ...
            <div className="text-sm text-center mt-4">
              <span className="text-black">Already have an account? </span>
              <a href="/login" className="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-200 ease-in-out">
                Login
              </a>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 flex justify-center space-x-4">
                {/* Facebook Icon */}
                <a href="#" className="text-blue-600 hover:text-blue-800 transform transition-transform duration-200 hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                  </svg>
                </a>
                {/* Google Icon */}
                <a href="#" className="text-red-600 hover:text-red-800 transform transition-transform duration-200 hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 256 262">
                ...
                {/* LinkedIn Icon */}
                <a href="#" className="text-blue-700 hover:text-blue-900 transform transition-transform duration-200 hover:scale-110">
